public class OOPBox {
	...
	private String 	hStr = "*";
	private String 	vStr = "*";
	private String  myName = "I am a Box"; 
	 ...
	 * @param hSize
	 */
	public OOPBox(int vSize, int hSize) {
		super();
		this.vSize = vSize;
		this.hSize = hSize;
	}
	 ...
	 * @param vStr
	 */
	public OOPBox(String hStr, String vStr) {
		super();
		this.hStr = hStr;
		this.vStr = vStr;
	}
	 ...
	 * @param vStr
	 */
	public OOPBox(int vSize, int hSize, String hStr, String vStr) {
		super();
		this.vSize = vSize;
		this.hSize = hSize;
		this.hStr = hStr;
	...
	public OOPBox(int vSize, int hSize, String hStr, String vStr, String name) {
		super();
		this.vSize = vSize;
		this.hSize = hSize;
		this.hStr = hStr;
